...
<tr><td colspan="3" style="font-family:Lucida Calligraphy; font-size:20px; color:purple;"><span class="middletext">Pack Name:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[1];?></td></tr>
...
<tr><td  colspan="3" height="90px"><span class="middletext" style="font-family:Lucida Calligraphy; font-size:20px; color:purple;">Category:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $data[10];?>
 <br/>
  <span class="middletext" style="font-family:Lucida Calligraphy; font-size:20px; color:purple;">Subcategory:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[12];?>
  <br/>
   <span class="middletext" style="font-family:Lucida Calligraphy; font-size:20px; color:purple;">Price:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <?php echo $data[4];?>
</td></tr>
